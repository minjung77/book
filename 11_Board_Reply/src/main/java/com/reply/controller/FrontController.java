...
public class FrontController extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		FileInputStream fis = 
				new FileInputStream("C:\\Users\\admin\\Desktop\\11_Board_Reply\\src\\main\\java\\com\\reply\\controller\\mapping.properties");
		...
		if(value.substring(0, 7).equals("execute")) {
			...
			try {
				...
				// 가져온 기본생성자를 이용하여 newInstance() 메서드를
				// 호출하여 객체를 동적으로 생성하는 메서드.
